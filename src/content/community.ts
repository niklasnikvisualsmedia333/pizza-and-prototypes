...
export const communityContent: Record<Lang, CommunityContent> = {
  de: {
    ...
    freeText: 'Der Community-Beitritt und die Teilnahme an unseren Community-Events sind kostenlos. Möglich machen das unsere Partner und Sponsoren.',
  ...
  en: {
    ...
    freeText: 'Joining the community and attending our community events is free. Our partners and sponsors make this possible.',
