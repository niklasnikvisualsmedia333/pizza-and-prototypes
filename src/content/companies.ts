...
export const companiesContent: Record<Lang, CompaniesContent> = {
  de: {
    ...
    heroText:
      'Tech Meets Problems verbindet Unternehmen mit einer wachsenden Community mit Wurzeln in Siegen. Ein großer Teil besteht aus technischen Studierenden, darunter viele Masterstudierende. Hinzu kommen junge Berufstätige und weitere techniknahe Profile aus der Region und darüber hinaus. Gemeinsam entstehen neue Perspektiven, erste Ansätze und passende nächste Schritte.',
    ...
    benefits: [
      { title: 'Zugang zu technischen Talenten', text: 'Direkter Austausch mit technischen Studierenden, jungen Berufstätigen und weiteren techniknahen Profilen aus der Region und darüber hinaus.' },
    ...
    disciplinesTitle: 'Technische und techniknahe Profile mit Wurzeln in Siegen.',
    disciplinesText: 'Eine wachsende technische Community mit Profilen aus der Region und darüber hinaus bringt unterschiedliche Perspektiven zusammen.',
    disciplines: [
    ...
    contactTitle: 'Lassen Sie uns über mögliche Anknüpfungspunkte sprechen.',
  ...
  en: {
    ...
    heroText: 'Tech Meets Problems connects companies with a growing community rooted in Siegen. A large part of the community consists of technical students, including many master’s students. Young professionals and other tech-oriented profiles from the region and beyond add further experience. Together, we develop new perspectives, first approaches and suitable next steps.',
    ...
    benefits: [
      { title: 'Access to technical talent', text: 'Direct exchange with technical students, young professionals and other tech-adjacent profiles from the region and beyond.' },
    ...
    disciplinesTitle: 'Technical and tech-adjacent profiles rooted in Siegen.',
    disciplinesText: 'A growing technical community with profiles from the region and beyond brings different perspectives together.',
    disciplines: [
    ...
    contactTitle: 'Let’s talk about potential ways to work together.',
